        ...
        connexionService.howIsLogIn()
            .then(res => {
                if (res.data.role === "COMMERCIAL") {
                    ...
                    commercialService.getMySousAdv(res.data.contactSim)
                        .then(resp=>{
        ...
        <div>
            ...
            <div >
                ...
                <Descriptions contentStyle={{fontWeight:'semi-bold',fontSize:15}} labelStyle={{color:'#800080', fontWeight:'bold',fontSize:16}} >
                    ...
                    <Descriptions.Item label="Contact perso">{commercial.contactPerso}</Descriptions.Item>
                    <Descriptions.Item label="Localication">{commercial.situationGeo} {}</Descriptions.Item>
                    <Descriptions.Item label="Email ">{commercial.email}</Descriptions.Item>
                    <Descriptions.Item label="Secteur">{commercial.secteur}</Descriptions.Item>
                ...
                <Descriptions contentStyle={{fontWeight:'semi-bold',fontSize:15}} labelStyle={{color:'#800080', fontWeight:'bold',fontSize:16}} >
                    ...
                    <Descriptions.Item label="Numero CNI ">{commercial.piece?commercial.piece.numeroCni:"..."}</Descriptions.Item>
                    <Descriptions.Item label="Date de naissance ">{commercial.piece?commercial.piece.dateNaissance:"..."}</Descriptions.Item>
                    <Descriptions.Item label="Lieu de naissance ">{commercial.piece?commercial.piece.lieu:"..."}</Descriptions.Item>
                    
                </Descriptions>

                <Divider orientation='left'>Information sous adv</Divider>

                <Descriptions contentStyle={{fontSize:12, fontStyle:'italic'}} labelStyle={{color:'#800080',fontSize:12,fontStyle:'italic'}} >

                    <Descriptions.Item  label="Nom Sous Adv">{sousadv.nom}</Descriptions.Item>
